...
void	Harl::info(void)
{
	...
	std::cout << "I cannot believe adding extra"
			<< " bacon costs more money. You didn’t"
...
{
	HarlFuncPointer	complain_funcs[4] = {&Harl::debug, &Harl::info, &Harl::warning, &Harl::error};
	std::string		func_names[4] = {"DEBUG", "INFO", "WARNING", "ERROR"};

	for (int i = 0; i < 4; i++)
	{
		if (func_names[i].compare(level) == 0)
		{
