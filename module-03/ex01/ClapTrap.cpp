...
{
	std::cout << "ClapTrap copy constructor called. Source is " << src._name << std::endl;
...
{
	std::cout << "ClapTrap copy assignment operator called. LHS = " << this->_name << " RHS = " << rhs._name << std::endl;
